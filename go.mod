...
require (
	git.code.oa.com/components/l5 v0.2.2 // indirect
	git.code.oa.com/iegm-open/gl5 v1.0.4 // indirect
	git.code.oa.com/iegm-open/polaris v0.0.1 // indirect
	git.code.oa.com/polaris/polaris-go v0.7.6 // indirect
	git.code.oa.com/trpc-go/trpc-go v0.9.3 // indirect
